...
6) For presentation. Adding Domain for external users. Adding filter for Authentication Context matching *c10* to *c19* and Conditional Access policy name matching *AC - c10* to *AC - c10*. Displaying relevant results.
